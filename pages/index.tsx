    ...
    <div className="flex min-h-screen flex-col items-center justify-center py-2 bg-gray-100">
      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          <a href="data" className="border-2 border-blue-800 text-blue-800 rounded-full px-12 py-2 inline-block font-semibold hover:bg-blue-800 hover:text-white">Sign In</a>
        </div>
        </div>
        </div>
        <div className="w-2/5 bg-blue-500 rounded-tr-2xl rounded-br-2xl py-36 px-12">
          ...
          <p className="mb-10">Fill up personal information and start the game.</p>
          <a href="#" className="border-2 border-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white hover:text-blue-800">Sign Up</a>
        </div>{/* SIGN-up*/}  
        </div>
      </main>
    </div>
